...
public abstract class Validator implements Interceptor {
	...
	final public void intercept(Invocation invocation) {
		...
		validator.controller = invocation.getR();
	 ...
	 */
	protected abstract void validate(Resource c);
	 ...
	 */
	protected abstract void handleError(Resource c);
	...
	protected void addError(String errorKey, String errorMessage) {
		invalid = true;
		controller.setPara(errorKey, errorMessage);
		if (shortCircuit) {
	 ...
	 */
	protected Resource getController() {
		return controller;
	}
	...
	protected void validateRequired(int index, String errorKey, String errorMessage) {
		String value = String.valueOf(controller.getPara(index));
	...
	protected void validateRequiredString(int index, String errorKey, String errorMessage) {
		if (StrKit.isBlank(String.valueOf(controller.getPara(index))))
			addError(errorKey, errorMessage);
	}
	...
	protected void validateString(int index, int minLen, int maxLen, String errorKey, String errorMessage) {
		validateStringValue(String.valueOf(controller.getPara(index)), minLen, maxLen, errorKey, errorMessage);
	}
	...
	protected void validateBoolean(String field, String errorKey, String errorMessage) {
		validateBooleanValue(String.valueOf(controller.getPara(field)), errorKey, errorMessage);
	}
	...
	protected void validateBoolean(int index, String errorKey, String errorMessage) {
		validateBooleanValue(String.valueOf(controller.getPara(index)), errorKey, errorMessage);
	}
