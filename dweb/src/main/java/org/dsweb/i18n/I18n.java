 ...
 *    res.get("msg");				// return value: 你好 DSweb! 你好{0}!<br>
 *    res.format("msg", "涛");		// return value: 你好 DSweb! 你好涛!<br><br>
 *    
 *    res = I18n.use("demo", "en_US");<br>
 *    res.get("msg");				// return value: Hello DSweb! Hello{0}!<br>
 *    res.format("msg", "james");	// return value: Hello DSweb! Hello James!<br>
 * </p>
 */
public class I18n {
